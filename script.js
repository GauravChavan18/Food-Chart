...
function listcategoryVegetables() {
  let ans = fooddata.filter((element) => {
...
function listHighestprotientolow() {
  let ans = [];
  ans = fooddata.sort((a, b) => b.protiens - a.protiens);
  console.log(ans);
}

// list all the food items with lowest protien content to highest

function listLowestprotientohigh() {
  let ans = [];
  ans = fooddata.sort((a, b) => a.protiens - b.protiens);
  console.log(ans);
}
